...
const Cards = ({ path, name, post, social = {} }) => {
  ...
  useGSAP(
    () => {
      ...
      tl.fromTo(
        [imageRef.current, contentRef.current, ...iconsRef.current],
        { opacity: 0, y: 20 },
        {
          opacity: 1,
          y: 0,
  ...
  return (
    <div
      ...
      className="group max-w-[14rem] rounded-2xl h-max overflow-hidden transition-all duration-300 hover:shadow-2xl"
      style={{
    ...
    >
      ...
      <div ref={imageRef} className="h-56 w-full overflow-hidden relative">
      ...
      >
        <h2 className="text-sm font-bold text-white mb-2 tracking-wide">
          {name}
        </h2>
        ...
        {[
          ...
          <a
            ...
            className={`transform transition-all duration-300 hover:scale-110 ${
              !platform.url ? "opacity-50 cursor-default" : "hover:opacity-80"
            }`}
